...
# Beispiel f&#252;r asynchrone Ausf&#252;hrung (Benachrichtigungsmethode)
  Die Codebeispiele in diesem Thema demonstrieren, wie die [asynchrone Ausführung \( Benachrichtigungsmethode\)](http://msdn.microsoft.com/library/hh405038(VS.85).aspx) verwendet werden kann.  
