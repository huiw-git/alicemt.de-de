---
title: "Auftragseigenschaften - neuer Auftrag (Benachrichtigungsseite)"
ms.custom: na
ms.date: 07/15/2016
...
translation.priority.mt: 
  ...
  - zh-tw
---
# Auftragseigenschaften - neuer Auftrag (Benachrichtigungsseite)
Auf dieser Seite können Sie die Aktionen für den [!INCLUDE[msCoName](../content/includes/msCoName_md.md)] [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] -Agent festlegen, die bei Abschluss des Auftrags auszuführen sind.  
  
## Optionen  
**E\-e-Mail-Nachrichten**  
Wählen Sie diese Option zum Senden von e-Mail\-senden, wenn der Auftrag abgeschlossen ist. Nachdem Sie die Option ausgewählt haben, müssen Sie den zu benachrichtigenden Operator und die Bedingung auswählen, durch die die Benachrichtigung ausgelöst wird. Die Bedingungen sind **Bei erfolgreicher Auftragsausführung**, **Bei Auftragsfehler**oder **Beim Abschluss des Auftrags**.  
  
**Page**  
Wählen Sie diese Option zum Senden von e-Mail\-e-Mail-Nachrichten an einen Operator per Pager bei Beendigung des Auftrags. Nachdem Sie die Option ausgewählt haben, müssen Sie den zu benachrichtigenden Operator und die Bedingung auswählen, durch die die Benachrichtigung ausgelöst wird. Die Bedingungen sind **Bei erfolgreicher Auftragsausführung**, **Bei Auftragsfehler**oder **Beim Abschluss des Auftrags**.  
