...
|Ausblenden der Toolbox|Klicken Sie im Menü **Fenster** auf **Ausblenden**. (Um die Toolbox wieder zu öffnen, klicken Sie auf **Toolbox** auf die **Ansicht** Menü.)|  
|Erweitern einer Toolboxregisterkarte|Klicken Sie auf die gewünschte Registerkarte in der Toolbox.|  
|Erweitern der Toolboxregisterkarten nacheinander|Drücken Sie STRG\+unten, um die nächste Toolboxregisterkarte oder STRG erweitern\+Pfeil, um die vorherige Registerkarte zu erweitern.|  
|Erstellen einer neuen Toolboxregisterkarte|Rechts\-Klicken Sie auf eine beliebige Stelle in der Toolbox, und klicken Sie dann auf **Registerkarte hinzufügen**. Geben Sie den Namen für die neue Registerkarte ein, und drücken Sie dann die EINGABETASTE.|  
|Einfügen eines Toolboxelements an der ausgewählten Stelle des Designers|Ziehen Sie ein Element aus der Toolbox in den Designer oder Double\-Klicken Sie auf das gewünschte Element in der erweiterten Toolboxregisterkarte.|  
...
|Umbenennen eines Toolboxelements|Rechts\-Klicken Sie auf das Toolboxelement, und klicken Sie auf **Element umbenennen** im Kontextmenü.|  
