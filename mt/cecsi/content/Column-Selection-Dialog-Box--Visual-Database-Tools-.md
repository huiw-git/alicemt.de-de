---
title: "Spaltenauswahl (Dialogfeld) (Visual Database Tools)"
ms.custom: na
ms.date: 07/15/2016
...
translation.priority.mt: 
  ...
  - zh-tw
---
# Spaltenauswahl (Dialogfeld) (Visual Database Tools)
...
Dieses Dialogfeld wird angezeigt, wenn Sie mit der rechten Maustaste\-Klicken Sie auf eine Tabelle, und wählen Sie dann **benutzerdefinierte Sicht ändern** aus dem Kontextmenü.  
...
**Pfeilschaltflächen**  
Verwenden Sie die nach-oben und nach-unten-Pfeil, um markierte Spalten nach oben oder unten verschieben, der **Ausgewählte Spalten** Liste.  
