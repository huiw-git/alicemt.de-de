---
title: "Spalten mit geringer Dichte"
ms.custom: na
ms.date: 07/01/2016
...
# Spalten mit geringer Dichte
 ...
 In [!INCLUDE[ssNoVersion](../content/includes/ssNoVersion_md.md)] JDBC Driver 3.0 werden bei der Herstellung einer Verbindung mit einem [!INCLUDE[ssKatmai](../content/includes/ssKatmai_md.md)] \(oder höher\)\-Server Spalten mit geringer Dichte unterstützt. Sie können [SQLServerDatabaseMetaData.getColumns](../content/getColumns-Method--SQLServerDatabaseMetaData-.md), [SQLServerDatabaseMetaData.getFunctionColumns](../content/getFunctionColumns-Method--SQLServerDatabaseMetaData-.md) oder [SQLServerDatabaseMetaData.getProcedureColumns](../content/getProcedureColumns-Method--SQLServerDatabaseMetaData-.md) verwenden, um zu ermitteln, welche Spalten geringe Dichte aufweisen und welche Spalte die festgelegte Spalte ist.  
