...
translation.priority.ht: 
  ...
  - zh-tw
---
# getBytes-Methode (int) (SQLServerResultSet)
  Ruft den Wert des angegebenen Spaltenindexes in der aktuellen Zeile dieses [SQLServerResultSet](../content/SQLServerResultSet-Class.md)\-Objekts als Array vom Typ **byte** in der Programmiersprache Java ab.  
