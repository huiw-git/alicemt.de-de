---
title: "Optionen (Designer - Tabellen- und Datenbank-Designer)"
ms.custom: na
ms.date: 07/27/2016
...
translation.priority.mt: 
  ...
  - zh-tw
---
# Optionen (Designer - Tabellen- und Datenbank-Designer)
Auf dieser Seite können Sie das Standardverhalten des Designers bestimmen. Zum Zugriff auf die Einstellungen in der **Tools** Menü klicken Sie auf **Optionen**, erweitern Sie die **Designer** Ordner, und klicken Sie auf **Tabellen-Designer**.  
  
## Liste der Benutzeroberflächenelemente  
**Verbindungszeit Zeichenfolge überschreiben\-Wert für Tabellen-Designer-Updates**  
Ermöglicht eine neue Zeit\-Wert für die Aktionen des Tabellen-Designers festgelegt werden. Das kann hilfreich sein, wenn der Tabellen-Designer Auswirkungen auf eine große Tabelle hat und für die Änderung der Tabelle zusätzliche Zeit benötigt.  
  
**Transaktionszeit\-nach dem Verkleinern**  
Legt eine lange\-Wert für den Tabellen-Designer.  
...
**Speichern von Änderungen, die Tabelle erneut erfordern verhindern\-Erstellen**  
Verhindert, dass einen Benutzer Änderungen, die re erfordern\-Erstellen der Tabelle. Die folgenden Aktionen müssen möglicherweise eine Tabelle neu\-erstellt:  
...
Öffnet automatisch die **Tabelle hinzufügen** Dialogfeld beim Öffnen der Designer.  
