---
title: "getObject-Methode (int) (ISQLServerResultSet)"
ms.custom: na
ms.date: 07/27/2016
...
translation.priority.ht: 
  ...
  - zh-tw
---
# getObject-Methode (int) (ISQLServerResultSet)
    
## getObject\-Methode \(int\) \(ISQLServerResultSet\)  
 Ruft den Wert des angegebenen Spaltenindexes in der aktuellen Zeile dieses [SQLServerResultSet](../content/SQLServerResultSet-Class.md)\-Objekts als Objekt in der Programmiersprache Java ab.  
