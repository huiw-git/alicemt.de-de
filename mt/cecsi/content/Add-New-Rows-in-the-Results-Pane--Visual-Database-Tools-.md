---
title: "Hinzuf&#252;gen neuer Zeilen im Ergebnisbereich (Visual Database Tools)"
ms.custom: na
ms.date: 07/27/2016
...
translation.priority.mt: 
  ...
  - zh-tw
---
# Hinzuf&#252;gen neuer Zeilen im Ergebnisbereich (Visual Database Tools)
...
Informationen zur Dateneingabe finden Sie unter [Regeln für das Aktualisieren von Ergebnissen & #40; Visual Database Tools & #41;](../content/Rules-for-Updating-Results--Visual-Database-Tools-.md).  
  
### So fügen Sie eine neue Datenzeile ein  
...
1.  Wechseln Sie in den unteren Teil des Ergebnisbereichs, in dem eine leere Zeile für das Hinzufügen einer neuen Datenzeile verfügbar ist.  
    ...
    Die Anfangswerte aller Spalten werden *NULL*.  
...
3.  Geben Sie die Daten für die neue Zeile ein. Wenn Sie einfügen möchten, wählen Sie **Einfügen** aus der **Bearbeiten** Menü.  
