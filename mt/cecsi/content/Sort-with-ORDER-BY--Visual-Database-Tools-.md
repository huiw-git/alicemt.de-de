---
title: "Sortieren mit ORDER BY (Visual Database Tools)"
ms.custom: na
ms.date: 07/15/2016
...
translation.priority.mt: 
  ...
  - zh-tw
---
# Sortieren mit ORDER BY (Visual Database Tools)
...
### So sortieren Sie eine Abfrage mit einer ORDER BY-Klausel  
  
1.  Öffnen Sie eine Abfrage, oder erstellen Sie eine neue.  
  
2.  In der [im Kriterienbereich](../content/Criteria-Pane--Visual-Database-Tools-.md), klicken Sie auf die **Sortierungsart** Spalte für die entsprechende Zeile für die Spalte, die verwenden, um die Abfrageergebnisse sortiert werden sollen.  
  
3.  Wählen Sie *Aufsteigend* oder *Absteigend* aus der Dropdownliste\--Liste.  
  
> [!NOTE]  
> Deaktivieren der **Sortierungsart** Eintrag für eine Spalte die Spalte aus der ORDER BY-Klausel entfernt.  
