...
<caps:SxS xmlns:caps="http://schemas.microsoft.com/build/caps/2013/11">
  <caps:SxSTarget locale="de-DE">
    <developerReferenceWithSyntaxDocument xsi:schemaLocation="http://ddue.schemas.microsoft.com/authoring/2003/5 http://dduestorage.blob.core.windows.net/ddueschema/developer.xsd" xmlns="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
      <introduction>
        <para>
          <caps:sentence sentenceid="36a7e86405b22bbd9c5d16af2bd13f7b" id="tgt1" class="tgtSentence">Indicates whether a sort order is ascending or descending.</caps:sentence>
        </para>
      ...
      <parameters>
        <content>
          <definitionTable>
            ...
            <definition>
              <para>
                <caps:sentence sentenceid="e80af64ffde001cea4b399459d5bcda0" id="tgt9" class="tgtSentence">A <languageKeyword>Boolean</languageKeyword> value that, when set to <languageKeyword>True</languageKeyword>, indicates the sort direction is ascending.</caps:sentence>
                <caps:sentence sentenceid="39eda8d8ddf846c7302bf9c1a7f67e09" id="tgt10" class="tgtSentence">
                  <languageKeyword>False</languageKeyword> indicates descending order.</caps:sentence>
              </para>
            </definition>
          </definitionTable>
        </content>
  ...
  <caps:SxSSource locale="en-US">
    <developerReferenceWithSyntaxDocument xsi:schemaLocation="http://ddue.schemas.microsoft.com/authoring/2003/5 http://dduestorage.blob.core.windows.net/ddueschema/developer.xsd" xmlns="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
      <introduction>
        <para>
          <caps:sentence id="src1" class="srcSentence">Indicates whether a sort order is ascending or descending.</caps:sentence>
        </para>
        <alert class="important">
          <para>
      ...
      <parameters>
        <content>
          <definitionTable>
            ...
            <definition>
              <para>
                <caps:sentence id="src9" class="srcSentence">A <languageKeyword>Boolean</languageKeyword> value that, when set to <languageKeyword>True</languageKeyword>, indicates the sort direction is ascending.</caps:sentence>
      ...
      <languageReferenceRemarks>
        <content>
          <para>
            ...
            <caps:sentence id="src12" class="srcSentence"> The sorting functionality orders records by using values from one column.</caps:sentence>
