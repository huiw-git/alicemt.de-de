---
title: "getUnicodeStream-Methode (int)"
ms.custom: na
ms.date: 07/01/2016
...
translation.priority.ht: 
  ...
  - zh-tw
---
# getUnicodeStream-Methode (int)
    
## getUnicodeStream\-Methode \(int\)  
 Ruft den Wert des angegebenen Spaltenindexes in der aktuellen Zeile dieses [SQLServerResultSet](../content/SQLServerResultSet-Class.md)\-Objekts als Unicode\-Zeichendatenstrom ab.  
